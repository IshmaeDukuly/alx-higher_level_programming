...
class TestBase(unittest.TestCase):
    ...
    def test_id_not_given(self):
        """Test ids march incremented nb_objects when is not given"""
        self.assertTrue(Base(), self.id == 1)
        self.assertTrue(Base(), self.id == 2)

    def test_private_attr_access(self):
        """Test the  private attributes that are not accessible"""
    ...
    def test_invalid_args(self):
        """Test many args given throws error"""
        with self.assertRaises(TypeError):
            Base(50, 50)

    """Test class"""
    def test_class(self):
        """Test class created is the Base"""
    ...
    def test_from_none_json_string(self):
        """Test no JSON string that translates into empty Python dict"""
        s2 = None
    ...
    def test_from_empty_json_string(self):
        """Test no JSON string that translates into  an empty Python dict"""
        s3 = ""
        strs3 = Base.from_json_string(s3)
        self.assertTrue(type(strs3) == list)
        self.assertTrue(strs3 == [])

    """Test to creating instance from the dictionary"""
    def test_create(self):
        """Test transferring attr dictionary to another instance"""
    ...
    """Test saving JSON string represents dict to the class specific file"""
    ...
    def test_load_from_file(self):
        ...
        for m, n in enumerate(rec):
            if m == 0:
                self.assertEqual(str(n), '[Rectangle] (99) 2/8 - 10/7')
            if m == 1:
                self.assertEqual(str(n), '[Rectangle] (98) 2/2 - 2/4')
