...
class TestBase(unittest.TestCase):
    ...
    def test_id_not_given(self):
        """
        Test ids match incremented nb_objects when is not given
        """
    ...
    def test_load_from_file(self):
        ...
        for a, b in enumerate(recs):
            if a == 0:
                self.assertEqual(str(b), '[Rectangle] (99) 2/8 - 10/7')
            if a == 1:
                self.assertEqual(str(b), '[Rectangle] (98) 2/2 - 2/4')
