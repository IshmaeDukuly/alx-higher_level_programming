...
'''
    Creating the test cases base module
'''
...
class test_base(unittest.TestCase):
    ...
    def test_id_string(self):
        '''
           Don't send id an id that is not an int
        '''
        b = Base("Betty")
...
class TestSquare(unittest.TestCase):
    """
    class for Chect the base class' methods
    """
