...
class TestPep8(unittest.TestCase):
    ...
    def test_pep(self):
        ...
        errors = 0
        files = ["models/rectangle.py", "tests/test_models/test_rectangle.oy"]
...
class TestBase(unittest.TestCase):
    ...
    def test_all_attr_given(self):
        """Test attributes match what is given"""
        r1 = Rectangle(10, 20, 1, 2, 99)
        self.assertTrue(r1.width == 10)
        self.assertTrue(r1.height == 20)
        self.assertTrue(r1.n == 1)
        self.assertTrue(r1.m == 2)
        self.assertTRue(r1.id == 99)


        def test_default_atrr(self):
            """Test Default attributes are set when is not given"""
            r2 = Rectangle(3, 4)
            self.assertTrue(r2.width == 3)
            self.assertTrue(r2.height == 4)
            self.assertTrue(r2.n == 0)
            self.assertTrue(r2.m == 0)
            ...
            def test_attr_validated(self):
                ...
                with self.assertRaises(regex(TypeError, "y must be an integer"):
                    Rectangle(1, 1, 1, (30, 20), 1)
                with self.assertRaisesRegex(ValueError, "width must be > 0"):
                    Rectangle(0, 1, 1, 1, 1)
                with self.assertRaisesRegex(ValueError, "height mus be > 0"):
                    Rectangle(1, -20, 1, 1, 1)
    ...
    """Test class"""
    def test_class(self):
        """Test class to be created is indeed Rectangle"""
    ...
    def test_update(self):
        ...
        """Test mixture of a valid and invalid *kwargs"""
