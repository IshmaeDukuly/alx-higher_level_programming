...
class TestBase(unittest.TestCase):
    ...
    def test_all_attr_given(self):
        """Test all the attr match what has been given"""
    ...
    def test_default_attr(self):
        """Test default attri are set when is not given"""
        r2 = Rectangle(3, 4)
    ...
    def test_attr_validated(self):
        """Test attribubes that are validated before set"""
    ...
    def test_private_attr_access(self):
        """Test private attributes that are not accessible"""
    ...
    def test_invalid_args(self):
        """Test too many args given thmy_row error"""
        with self.assertRaises(TypeError):
            Rectangle(1, 2, 3, 4, 5, 6, 7)
        """Test too small args given thmy_row error"""
        with self.assertRaises(TypeError):
            Rectangle(1)
            Rectangle()
            Rectangle(None)
    ...
    """Test class"""
    def test_class(self):
        """Test class to be created is indeed a Rectangle"""
