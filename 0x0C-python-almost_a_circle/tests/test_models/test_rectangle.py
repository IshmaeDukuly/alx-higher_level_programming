...
'''
    This Runs the test cases for the Rectangle module
'''
...
class test_rectangle(unittest.TestCase):
    ...
    def test_update_dict(self):
        '''
            Testing an update method with **kwargs
        '''
    ...
    def test_to_dict_print(self):
        '''
            Testing a dict that will be printe
        '''
        r_1 = Rectangle(5, 4, 0, 0, 400)
    ...
    def test_missing_height(self):
        '''
            Expecting the type error because height and width are are not available
        '''
        with self.assertRaises(TypeError):
            Rectangle()
    ...
    def test_missing_width(self):
        '''
            Expecting error because width is not available
        '''
        with self.assertRaises(TypeError):
            Rectangle(1)
    ...
    def test_load_from_file_not_the_same(self):
        ...
        list_rectangles_input = [r_1]

        Rectangle.save_to_file(list_rectangles_input)

        list_rectangles_output = Rectangle.load_from_file()

        self.assertNotEqual(id(r_1), id(list_rectangles_output[0]))
    ...
    def test_load_from_file_same_width(self):
        ...
        self.assertEqual(r_1.width, list_rectangles_output[0].width)
    ...
    def test_load_from_file_same_height(self):
        ...
        self.assertEqual(r_1.height, list_rectangles_output[0].height)
    ...
    def test_load_from_file_same_x(self):
        ...
        self.assertEqual(r_1.x, list_rectangles_output[0].x)
    ...
    def test_load_from_file_same_y(self):
        ...
        self.assertEqual(r_1.y, list_rectangles_output[0].y)
...
class TestRectangle(unittest.TestCase):
    ...
    def test_func_docstrings(self):
        """
        Testing whether methods docstring documentation exits
        """
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """This wiil caputer and return text printed to stdout.
    ...
    def test_str_method_print_width_height(self):
        ...
        self.assertEqual(output, cap.getvalue())
    ...
    def test_display_width_height(self):
        ...
        cap = TestRectangle_stdout.capture_stdout(r, "display")
        self.assertEqual("##\n##\n##\n", cap.getvalue())
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id_and_more(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
        output = "[Rectangle] ({}) 2/10 - 4/5".format(r.id)
        self.assertEqual(output, str(r))
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        output = "[Rectangle] ({}) 10/9 - 10/7".format(r.id)
        self.assertEqual(output, str(r))
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        ...
        output = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 10}
        self.assertDictEqual(output, r.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        r_1 = Rectangle(10, 2, 1, 9, 5)
        r_2 = Rectangle(5, 9, 1, 2, 10)
        r_2.update(**r_1.to_dictionary())
        self.assertNotEqual(r_1, r_2)
