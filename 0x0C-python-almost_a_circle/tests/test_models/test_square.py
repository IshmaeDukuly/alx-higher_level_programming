...
class test_square(unittest.TestCase):
    ...
    def tearDown(self):
        '''
          Destroyting the created instance
        '''
        try:
    ...
    def test_update_dict(self):
        '''
            Test an update method with **kwargs
        '''
    ...
    def test_update_dict_list(self):
        '''
            Test an update method with **kwargs and *args
        '''
    ...
    def test_to_dict(self):
        ...
        '''
        r_1 = Square(5)
        self.assertEqual(type(r_1.to_dictionary()), dict)

    def test_to_dict_print(self):
        '''
            Testing the dict that will be printed
        '''
        r_1 = Square(5, 0, 0, 410)
        r_1_dict = r_1.to_dictionary()
        self.assertEqual(r_1_dict,
                         {'size': 5, 'id': 410, 'x': 0, 'y': 0})

    def test_missing_height(self):
        '''
            This is expecting the type error because, height and width are missing
        '''
        with self.assertRaises(TypeError):
            Square()
    ...
    def test_saving_to_file(self):
        '''
            Testin saving a file into json format
        '''
        try:
            os.remove("Square.json")
        except:
            pass
        r_1 = Square(5, 0, 0, 346)
        Square.save_to_file([r_1])
    ...
    def test_saving_to_file_no_iter(self):
        '''
            Transfering the non iterable function
        '''
        with self.assertRaises(TypeError):
    ...
    def test_saving_to_file_type(self):
        '''
            The testing og=f saving a file into json format and testing the type
        '''
        try:
            os.remove("Square.json")
        except:
    ...
    def test_json_string_type(self):
            ...
            list_outcome = Square.from_json_string(json_list_input)
    ...
    def test_dict_to_instance(self):
        '''
           Testing that an instance is created from the dict
        '''
        r_1 = Square(5)
        r_1_dictionary = r_1.to_dictionary()
        r_2 = Square.create(**r_1_dictionary)
    ...
    def test_load_from_file_not_the_same(self):
        '''
            Checking an item was created from the list and has different address
        '''
        r_1 = Square(10)
        list_squares_input = [r_1]

        Square.save_to_file(list_squares_input)

        list_squares_outcome = Square.load_from_file()

        self.assertNotEqual(id(r_1), id(list_squares_outcome[0]))

    def test_load_from_file_same_width(self):
        '''
           Checking to know an object was created from the list that have sameh
        '''
        r_1 = Square(10)
        list_squares_input = [r_1]
        ...
        self.assertEqual(r_1.width, list_squares_outcome[0].size)

    def test_load_from_file_same_height(self):
        '''
          Checking to know an object was created from the list that have same height
        '''
        r_1 = Square(10)
        list_squares_input = [r_1]
        ...
        self.assertEqual(r_1.size, list_squares_outcome[0].size)

    def test_load_from_file_same_x(self):
        '''Checking to know an object list has the same letter
        '''
        r_1 = Square(10, 2, 8)
        list_squares_input = [r_1]
        ...
        self.assertEqual(r_1.x, list_squares_outcome[0].x)

    def test_load_from_file_same_y(self):
        '''
           Checking to know an object list has the same lettersy
        '''
        r_1 = Square(10, 2, 8)
        list_squares_input = [r_1]
        ...
        self.assertEqual(r_1.y, list_squares_outcome[0].y)

    def test_display_square(self):
        '''
            Verify the standard outcome
        '''
       snapoutcome = StringIO()
        sys.stdout =snapoutcome
        r_1 = Square(10)
        r_1.display()
        ...
        outcome = ("##########\n" +
                  ...
                  "##########\n" +
                  "##########\n")
        self.assertEqual(snapoutcome.getvalue(), outcome)
...
class TestSquare(unittest.TestCase):
    ...
    def test_inputted_types(self):
        """
       The different type of an inputted args
        """
        with self.assertRaises(TypeError):
...
class TestSquare(unittest.TestCase):
    ...
    def test_10_0(self):
        """Test Square class: look for the the attributes."""
    ...
    # def test_10_3(self):
    #     """Test Square class:look for the the mising args."""
    ...
    def test_11_0(self):
        """Test Square class: look for the size atrributes."""
    ...
    def test_11_1(self):
        """Test Square class: look for the the wron chars."""
    ...
    def test_12_1(self):
        """An update method on Sqaure with wrong types."""
    ...
    def test_14_0(self):
        """Ths is the test for the public method to_dictionary."""
    ...
    # def test_14_1(self):
    #     """Ths is the test for the public method to_dictionary with wrong args."""
